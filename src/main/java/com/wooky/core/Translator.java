...
public class Translator {
    ...
    public String[] translationKeys() {
        ...
        return new String[] { MENU_LIST, MENU_SEARCH, MENU_ADD, MENU_LOGIN, CONTENT_NAME, CONTENT_SURNAME,
                CONTENT_EMAIL, CONTENT_PHONE_CODE, CONTENT_PHONE, CONTENT_BIRTHDATE, CONTENT_SAVE, CONTENT_CLOSE,
                CONTENT_EDIT, CONTENT_UPDATE, CONTENT_DELETE, LIST_EMPTY, ERROR_INFO, ERROR_RETURN, SEARCH_INFO_PART_1,
                SEARCH_INFO_PART_2 };
    }
}
